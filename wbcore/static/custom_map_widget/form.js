        ...
        var LocationField = {
            ...
            load: {
                    google: function(options, onload) {
                        ...
                        var js = [
                            url,
                            this.path + '/static/custom_map_widget/leaflet-google.js'
                        ];
                ...
                googleSearchProvider: function(options, onload) {
                    ...
                    var js = [
                            url,
                            this.path + '/static/custom_map_widget/l.geosearch.provider.google.js'
                        ];
                ...
                //path_extend = 'static/custom_map_widget/',
                //path_extend = '';
